...
!function (window) {
    ...
    CitySelect.prototype.open = function () {
        ...
        if (defaultSet.provance) {
            _this.setNavTxt(0, defaultSet.provance,defaultSet.provance_id);
        } else {
        ...
        if (defaultSet.city) {
            _this.loadCity();
            _this.setNavTxt(1, defaultSet.city,defaultSet.city_id)
        }

        if (defaultSet.area) {
            _this.loadArea();
            _this.ForwardView(false);
            _this.setNavTxt(2, defaultSet.area,defaultSet.area_id);
        }
    ...
    CitySelect.prototype.setNavTxt = function (index, txt,id) {
        ...
        $nav.eq(index).html(txt).data('id',id);
    ...
    CitySelect.prototype.bindItemEvent = function () {
        ...
        $cityElement.on('click.ydui.cityselect', '.cityselect-item-box a', function () {
            ...
            _this.setNavTxt(tag, $this.text(),$this.data('id'));
            ...
            if (tag == 0) {
                ...
                defaultSet.provance_id = $nav.eq(0).data('id');
                defaultSet.city_id = $nav.eq(1).data('id');
                defaultSet.area_id = $nav.eq(2).data('id');
    ...
    CitySelect.prototype.returnValue = function () {
        ...
        _this.$element.trigger($.Event('done.ydui.cityselect', {
            ...
            provance_id: defaultSet.provance_id,
            city_id: defaultSet.city_id,
            area_id: defaultSet.area_id
        }));
